        ...
        <div className='flex-1 px-2'>
          <div className='flex flex-row justify-between items-center m-2'>
            ...
            <div className='flex flex-col items-end'>
              ...
              <h4 className='font-semibold text-base'>{vehiclePlate}</h4>
          ...
          <div className='flex flex-row w-full justify-start items-center gap-3 mt-1 mb-2 ml-3'>
            ...
            <div className='flex flex-col items-start justify-around'>
              ...
              <h3 className='text-sm'>Kaikondrahalli, Bengluru, Karnataka</h3>
            </div>
          </div>
          ...
          <div className='w-full flex justify-start items-center gap-3 ml-3 mb-2'>
            ...
            <div className='flex flex-col items-start justify-around'>
              <h3 className='font-semibold text-base'>Third Wave Coffie</h3>
              <h3 className='text-sm'>17th cross road, Pwd Quartres, 1st sector, Hsr Layout, Bengaluru, Karnataka</h3>
            </div>
          </div>
