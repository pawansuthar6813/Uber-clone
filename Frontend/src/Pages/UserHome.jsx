...
//       <div className='absolute h-screen w-full flex flex-col justify-end z-10 left-0'>
//         <div className='h-[25%] w-full bg-white p-5 relative'>
//           <img className='absolute right-2 cursor-pointer' ref={arrRef} onClick={() => { setPanelOpen(false) }} src={downArrow} alt="down arrow" />
